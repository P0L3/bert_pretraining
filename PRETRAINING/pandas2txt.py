...
DIR = "/PRETRAINING/DATASET/ED4RE_2503/ED4RE_2603_tc_remaining_50.csv"
FINAL_DIR =  "/PRETRAINING/DATASET/ED4RE_2503/TOKENIZED/ED4RE_2603_tc_tokenized_remaining_50_"
BATCH_SIZE = 5
processed_rows = 0

RANGE = 18500 // BATCH_SIZE
...
for i in tqdm(range(RANGE)):
    ...
    try:
        ...
        df["Sentences"] = list(nlp.pipe(df['Content'], batch_size=5, n_process=1))
